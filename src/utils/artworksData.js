...
export const artworksData = [
  // Artemis W.
  {
    id: 'artemis-queer-futurism',
    title: 'Queer Futurism',
    artist: 'Artemis W.',
  ...
  },
  {
    ...
    title: 'The Ways in Which They See Me',
    artist: 'Artemis W.',
  ...
  {
    id: 'lauren-full',
    title: 'Sewn by Lauren D. Pineda, UA Theatre Production Major',
  ...
  {
    id: 'lauren-artemis',
    title: 'Artemis (Sewn by Lauren D. Pineda)',
    artist: 'Lauren D. Pineda',
    medium: 'Textile',
  ...
  {
    id: 'lauren-austen',
    title: 'Austen (Sewn by Lauren D. Pineda)',
    artist: 'Lauren D. Pineda',
    medium: 'Textile',
  ...
  {
    id: 'lauren-mercedez',
    title: 'Mercedez (Sewn by Lauren D. Pineda)',
    artist: 'Lauren D. Pineda',
    medium: 'Textile',
  ...
  {
    id: 'lauren-ruthann',
    title: 'RuthAnn (Sewn by Lauren D. Pineda)',
    artist: 'Lauren D. Pineda',
    medium: 'Textile',
  ...
  {
    id: 'lauren-sam',
    title: 'Sam (Sewn by Lauren D. Pineda)',
    artist: 'Lauren D. Pineda',
    medium: 'Textile',
  ...
  {
    id: 'lauren-savannah',
    title: 'Savannah (Sewn by Lauren D. Pineda)',
    artist: 'Lauren D. Pineda',
    medium: 'Textile',
  ...
  {
    id: 'austen-molotov',
    title: 'Molotov from the snowflakes',
    artist: 'Austen D.',
  ...
  },
  {
    ...
    title: '"Queer as in Fuck You" by Dog Park Dissidents',
    artist: 'Austen D.',
    medium: 'Pen on paper',
  ...
  // Elliott C.
  {
    id: 'elliott-flying-abraxas',
    title: 'Flying to Abraxas',
    artist: 'Elliott C.',
    medium: 'Unknown',
  ...
  // Savannah N.
  {
    id: 'savannah-perception-reality',
    title: 'Perception V. Reality',
    artist: 'Savannah N.',
    medium: 'Unknown',
  ...
  // Vanessa S.
  {
    id: 'vanessa-public-not-safe',
    title: 'The Public is Not Safe',
    artist: 'Vanessa S.',
...
// Artist metadata from the original site
export const artistMetadata = {
  'Artemis W.': {
    name: 'Artemis W.',
    pronouns: 'they/them',
    instagram: 'https://instagram.com/artie_doodle',
    instagramHandle: 'artie_doodle',
    description: null
  },
  'Austen D.': {
    name: 'Austen D.',
    pronouns: 'he/him',
    instagram: 'https://instagram.com/punx_not_dead_but_i_am_inside',
    instagramHandle: 'punx_not_dead_but_i_am_inside',
    description: null
  },
  'Elliott C.': {
    name: 'Elliott C.',
    ...
    deviantArt: 'https://www.deviantart.com/fantasyfanatic365',
    description: null
  },
  'Findley A.': {
    name: 'Findley A.',
    pronouns: 'they/them',
    instagram: 'https://instagram.com/dares.art',
    instagramHandle: 'dares.art',
    description: null
  },
  'Jay G.': {
    name: 'Jay G.',
    pronouns: 'he/him',
    instagram: 'https://instagram.com/a_little_bit_colorful',
    instagramHandle: 'a_little_bit_colorful',
    description: null
  },
  'Liam E.': {
    name: 'Liam E.',
  ...
  'Mercedez M.': {
    name: 'Mercedez M.',
    pronouns: 'monster child',
    instagram: 'https://instagram.com/A_real_work_of_art',
    instagramHandle: 'A_real_work_of_art',
    description: null
  },
  'RuthAnn G.': {
    name: 'RuthAnn G.',
  ...
  'Sam B.': {
    name: 'Sam B.',
    pronouns: 'he/him',
    instagram: 'https://instagram.com/beachboyart',
    instagramHandle: 'beachboyart',
    description: null
  },
  'Savannah N.': {
    name: 'Savannah N.',
    pronouns: 'she/they',
    instagram: 'https://instagram.com/Gravityfalling2000',
    instagramHandle: 'Gravityfalling2000',
    tumblr: 'https://sweetums0kitty.tumblr.com/',
    description: 'As an artist I think it\'s my job to show the world how I want to be seen through my art, I make art to say what I can\'t with words. Whether that\'s explaining how I wish I could present as nothing in my first painting Perception > Reality or standing up to the blatant bigotry and hate being spewed by the Terf movement like in Wingardium Transphobia. It\'s an artist\'s job to take on the ugly parts of the world and turn them into something brighter and more creative. I think that\'s why so many of my paintings feature glitter, that, and the fact that for the longest time that was the only watercolor pallet I had! Really 2020 has been such a dark and negative year, humanity needs some (read A LOT) of glitter!'
  },
  'Vanessa S.': {
    name: 'Vanessa S.',
    pronouns: 'they/them',
    instagram: 'https://instagram.com/vanessasoncco',
    instagramHandle: 'vanessasoncco',
    description: null
  },
  'Lauren D. Pineda': {
    name: 'Lauren D. Pineda',
    instagram: null,
    instagramHandle: null,
    description: null
  }
...
// Convert artworks to gallery format for GalleryModal
export function getArtworksGallery() {
  return {
    id: 'mapping-q-2020-artworks',
    name: 'Mapping Q: 2020 Artworks',
    images: artworksData.map(artwork => ({
