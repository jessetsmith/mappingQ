        ...
        <div className="footer-content">
          ...
          <div className="footer-info-section">
            <div className="footer-contact">
              <p className="footer-address">1031 N Olive Road, Tucson, AZ 85721-0002</p>
              <p className="footer-phone">520-621-7567</p>
              <p className="footer-email">
                <a href="mailto:artmuseum@email.arizona.edu" className="footer-email-link">
                  artmuseum@email.arizona.edu
                </a>
              </p>
            </div>
